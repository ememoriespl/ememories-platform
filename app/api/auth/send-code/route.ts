    ...
    html: `
      <div style="font-family:sans-serif;max-width:420px;margin:0 auto;padding:32px 24px">
        <div style="margin-bottom:28px">
          <img src="https://ememoriespl.vercel.app/logo-light-2x.png" alt="eMemories" width="140" height="34" style="display:block;border:0;text-decoration:none;outline:none"/>
        </div>
